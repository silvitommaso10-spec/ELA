...
sono un'intenzione: sono gli import veri, e sono le direzioni che le 31 regole di architettura
...
- **Le regole**, in codice: `tests/architecture/rules.py` (31 regole, ognuna con il suo caso
