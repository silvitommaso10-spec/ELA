...
def test_ports_are_exactly_the_twenty_two_required() -> None:
    ...
    from M7.3 (ADR 0022 §5), the three of phase 10 (ADR 0028, 0029, 0030) and ``SpeechPort`` from
    M11.1 (ADR 0033): a port is added with an ADR and a row here, never by accident."""
