...
def test_ports_are_exactly_the_twenty_five_required() -> None:
    ...
    ``CommandLauncher`` from M13.2 (ADR 0047) and ``LocalBeat`` from M13.3 (ADR 0048 §2): a port is
    added with an ADR and a row here, never by accident."""
