...
un `core.echo` che non chiede niente a nessuno, e un `workspace.write_note` che è MEDIUM e chiede
il tuo consenso.
...
Il primo step — l'echo — è stato eseguito; il secondo scrive un file, e scrivere è MEDIUM (§29): ELA si ferma
e chiede. Nessun tool viene eseguito senza una decisione del Guardian, e nel dubbio la decisione è
«no» (§33).
...
47fbce38-66ab-519c-b7dc-8cce4bd4a7f2  55ed2ab5-94aa-581f-9468-c4d247d9fe04  workspace.write_note  workspace/notes/first-task.md  workspace.write_note on workspace/notes/first-task.md for step 9c5b8f26-… (scrivere la nota del primo task): requires an authorization: none was given
```
...
9c5b8f26-1a2b-4c3d-8e4f-000000000002  COMPLETED  MEDIUM  workspace.write_note  scrivere la nota del primo task
```
...
2026-09-07T14:25:31.731288Z  PERMISSION_DECIDED     SYSTEM:permission-guardian  55ed2ab5-…  decide: ALLOWED workspace.write_note (LOW): covered by authorization …
