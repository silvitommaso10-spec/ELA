...
# Add ela.permissions here when it has code. ela.infrastructure.persistence is here because it
# keeps the authorizations the Guardian consumes (M2.1) and the audit log (M2.2); ela.audit holds
# the hash chain that makes the log tamper-evident (M2.2).
